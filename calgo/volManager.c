...
/**
 * @brief fichier volManager contenant les fonctions li�es au vol
 * @author Killian
 * @author Martin
 *
 */
...
void afficher_vols(Vol vols[])
{
    ...
    for (int i = 0; i < MAX_VOLS && vols[i].numero_vol != '\0'; i++) {
        // On v�rifie si le vol est dans les 3 heures � venir
...
void afficher_vol(Vol vol, int heure)
{
        ...
        // On affiche la salle d'embarquement et les heures si c'est d'actualit�
...
void rechercher_vol(Vol tableau_vols[])
{
    ...
    do
    {
        ...
        case '0':
            break;
        case '1': // Rechercher par compagnie a�rienne
